...
% the bounded quantification of system F serves a different purpose than the constrained quantification of relational types.
% In system F the upper bound on universally quantified variables serves as an external indicator, that a type may be specialized.
% The bounded quantification is not necessary in order to express the content of the type.
% in contrast, constrained quantification is used to express the content of a type precisely,
% similar to how first order quantification is used liquid types.
