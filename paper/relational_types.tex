...
\begin{mathpar}
  ...
  \inferrule { 
    \Delta \cdot \Gamma \Vdash e_1 : \tau_1' \sqsubseteq \tau_1
    \\
    \Delta \cdot (\Gamma, x \mapsto \text{pack}\ \Delta\ \tau_1')  \Vdash e_2 : \tau_2
    \\
  } {
    \Delta \cdot \Gamma 
    \Vdash 
  ...
  \inferrule { 
    \Delta \cdot \Gamma \Vdash e : \tau' \sqsubseteq \alpha \rightarrow \alpha'
    \\
    \alpha[\Delta] = \tau
    \\
    \alpha'[\Delta] = \sqcap_i \tau_i'
    \\
    \Delta;\Delta' \cdot \oslash \Vdash (\nu \alpha''\ .\ \sqcap_i (\text{twist}\ \alpha''\ \tau\ \tau_i'))
  } {
...
% \caption{Twisting. 
%   \newline
%   This function constructs a case of a co-inductive function type.  The \alpha input represents the co-inductive fixed point.  The \tau_1 input represents the co-inductive fixed point.
% }
...
\caption{Twisting.
  ...
  \newline
  The input $\tau_1$ represents a function case type ($\cdot \rightarrow \cdot$) type 
  constrained to be weaker than the fixed point. 
  \newline
...
\begin{mathpar}
  ...
  \inferrule {
    ...
    \bigwedge\nolimits_i\ \text{saferef}\ \alpha_i\ \Delta'
  } {
