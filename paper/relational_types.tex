...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \left< \Delta, \Gamma, (\text{fixtype}\ \Delta\ \alpha_1\ \alpha_2) \right>
...
% TODO: can we replace type adjustment with simply intersection on type environments on upward propagation
% union on type environments on downward propagation. 
% this has the nice property of only happening in type inference, not in unification.
\begin{flalign*}
  &\boxed{\Delta \in \llbracket \tau \leq \tau \rrbracket^\sharp}&
\end{flalign*}
\begin{mathpar}
  ...
  \inferrule {
    ...
    \\
    (\text{adjustable}\ \alpha \vee \Delta(\alpha) = \top)
    \\
    \tau' = \Delta(\alpha) \wedge \tau 
  } {
...
%     \alpha_2[\Delta] = \tau_2
%     \\\\
%     (\text{fixtype}\ \tau_1\ \tau_2) \sqsupseteq (\Gamma\ x)
%   } {
%     \Delta\ \cdot \Gamma 
