...
% polymorphic sampling
  % by allowing polymorphism in subtyping
    % we enable synthesizing usage of polymorphic function
  % we normalize sampling and defining of polymorphic function
    % both instantiation and generalization of polymorphism are baked into subtyping
  % by moving generalization into subtyping
    % we obviate the need for synchronized sequent calc.
    % the synchrony is subsumed by subtyping
