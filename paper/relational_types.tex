...
%% TODO: consider if compositional typing conflicts with the constraint-based formulation.
%% could have environments be constraint based, and compositional part be expressed with (\geq \tau)
\begin{flalign*}
...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \\
    (\wedge\ \widebar{l_i : (\Gamma\ x_i)}) \sqsubseteq (\Gamma\ x)
  } {
  ...
  \inferrule { 
    ...
    \\\\
    (\text{patenv}\ m_i) \sqsubseteq \Gamma
    \\
  ...
  \inferrule { 
    ...
    \alpha_2[\Delta] = \tau_2
    \\\\
    (\text{fixtype}\ \tau_1\ \tau_2) \sqsubseteq (\Gamma\ x)
  } {
    \Delta\ \cdot \Gamma 
