...
merely the interface of objects. Perhaps the most well known kind of expressive type systems are dependent type systems, 
seen in systems Twelf, ATS (Xi et al), Coq, Lean, and others. By allowing types to depend on terms, 
these systems enable the construction of terms that act as proofs of properties described in types. 
...
Predicate subtyping is an alternative approach, as seen in Liquid types and PVS, 
where predicates can refine types to a subtype that accepts a subset of the original set of terms.
...
Unlike, Liquid Haskell, our development does not rely on SMT solvers. In some ways this may be a limitation of our approach, 
as SMT solvers may provide results very fast for certain problems due to their integration with SAT's resolution. 
