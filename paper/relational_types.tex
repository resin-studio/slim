...
\begin{mathpar}
  ...
  % TODO: does collecting semantics require an environment for variables?
  % is substitution enough? or is environment needed for soundness?
  % concretizing version 
  % prove that concretize meets some property related to \sqsubseteq
  \\\\
  ...
  \inferrule { 
    ...
    \subseteq 
    \text{concretize}(\left< \Vdash e \right>)
  } 

\end{mathpar}

% TODO: write collecting semantics with WRONG value
