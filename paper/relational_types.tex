...
Another approach to type reconstruction is \textit{bidirectional typing} \cite{}.
In bidirectional typing, the goal is to reconstruct types locally 
by propagating type annotations downward. 
...
\textbf{TODO:} Think about connection between between type adjustment and predicate abstraction and predicate refinement.
