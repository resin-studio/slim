...
\begin{figure*}
\begin{flalign*}
  &\boxed{\left<\Gamma \cdot \tau \right> \in \alpha\ P}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
    \exists\ \varsigma \in P\ .\ \Gamma \vdash \varsigma : \tau
  } {
...
\begin{flalign*}
  &\boxed{\left<\Gamma \cdot \tau\right> \in \llbracket e \rrbracket^\sharp}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
    \Delta \cdot \Gamma \Vdash e : \tau \leq \top
  } {
    \left<\Gamma \cdot (\text{pack}\ \Delta\ \tau)\right> \in \llbracket e \rrbracket^\sharp
  }
\end{mathpar}
\caption{Type collecting semantics}
\end{figure*}
...
% the structure of input decreases as types widen/narrow
\begin{flalign*}
  &\boxed{\Delta \cdot \Gamma \Vdash e : \tau \leq \tau}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
    \Delta \cdot \bullet \Vdash (\Gamma\ x) \leq \tau
  } {
    \Delta \cdot \Gamma
    \Vdash x : (\Gamma\ x) \leq \tau
  } 

  \inferrule { 
    \Delta \cdot \bullet \Vdash \text{unit} \leq \tau
  } {
    \Delta \cdot \Gamma 
    \Vdash () : \text{unit} \leq \tau
  } 
