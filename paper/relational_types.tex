...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \Delta \vdash \left<\forall \widebar{\alpha}\ .\ \tau_3\ |\ \tau_1 \sqsubseteq \tau_2\right>
    \sqsubseteq \tau_4
  }
...
\begin{mathpar}
  \inferrule {
    ...
    \Delta \cdot \Omega \Vdash  
      (\forall \widebar{\alpha_i}\ .\ \tau_1\ |\ \tau_3 \sqsubseteq \tau_4)
      \sqsubseteq \tau_2
  }
  ...
  \inferrule {
    ...
    \Delta \cdot \Omega \Vdash \tau_1 \sqsubseteq 
      (\exists \widebar{\alpha_i}\ .\ \tau_2\ |\ \tau_3 \sqsubseteq \tau_4)
  }
  ...
  \inferrule {
    ...
    \Delta \cdot \Omega \Vdash 
      (\exists \widebar{\alpha_i}\ .\ \tau_1\ |\ \tau_3 \sqsubseteq \tau_4) \sqsubseteq
      \tau_2
  }
  ...
  \inferrule {
    ...
    \Delta \cdot \Omega \Vdash 
      \tau_1
      \sqsubseteq
      (\forall \widebar{\alpha_i}\ .\ \tau_2\ |\ \tau_3 \sqsubseteq \tau_4)
  }
\end{mathpar}
...
\begin{mathpar}
  ...
  \inferrule {
    ...
    \Delta;\Delta' \cdot \Omega \Vdash \tau_1 \vee \tau_2 \sqsubseteq \tau_3
  }

  \inferrule {
    \Delta \cdot \Omega \Vdash \tau_1 \sqsubseteq \tau_2
  } {
    \Delta \cdot \Omega \Vdash \tau_1 \sqsubseteq \tau_2 \vee \tau_3
  }
