...
\begin{mathpar}
  ...
  \inferrule[TypeEnvBase] { 
  } {
    (\Gamma, x \mapsto \tau)(x) = \tau 
  } 


  \inferrule[TypeEnvStep] { 
    x \neq 'x 
    \\
    \Gamma(x) = \tau
  } {
  ...
  \inferrule[DomTypeEnvLeaf] { 
  } {
    x \in \text{dom}(\Gamma, x \mapsto \tau)
  } 

  \inferrule[DomTypeEnvStep] { 
    x \neq 'x 
    \\
    x \in \text{dom}(\Gamma)
  } {
...
\begin{mathpar}
  \inferrule[Hole] { 
    ...
    \bot \in \left< \Gamma \vdash \_ \right>
  } 
  ...
  \inferrule[Record] { 
    ...
    \in \left< \Gamma \vdash \omega\ (\widebar{l_i \approx t_i}) \right>  
  } 
