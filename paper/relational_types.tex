...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \left< \kappa, \rho, \text{let}\ x : \tau = c_1\ \text{in}\ c_2 \right> 
    \hookrightarrow 
...
\begin{flalign*}
  &\boxed{\Delta \cdot \Gamma \models e^z : \tau}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
    \Delta \models \text{unit} \leq \tau
    \\
    \text{unit} \sqsubseteq (\Gamma\ z)
  } {
    \Delta \cdot \Gamma \models ()^z : \tau
  } 

  \inferrule { 
    \Delta \models (\Gamma\ x) \leq \tau
    \\
    (\Gamma\ x)  \sqsubseteq (\Gamma\ z)
  } {
    \Delta \cdot \Gamma \models  x^z : \tau
  } 
  ...
  \inferrule { 
    ...
    \\
    \Delta \cdot \Gamma \cdot \tau' \models e : \alpha
    \\
    (l * \tau') \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma \models (l \cdot e)^z : \tau
  } 
  ...
  \inferrule { 
    ...
    \\
    \bigwedge \Delta \cdot \Gamma \cdot \tau_i' \models e_i : \alpha_i
    \\
    (\wedge\ \widebar{l_i : \tau_i'}) \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma \models (\sigma\ \widebar{l_i = e_i})^z : \tau
  } 
  ...
  \inferrule { 
    ...
    \\
    \bigwedge \Delta \cdot \Gamma \cdot \tau_i' \models m_i : \alpha'_i
    \\
    \bigwedge \Delta \cdot \Gamma \cdot \tau_i'' \models e_i : \alpha''_i
    \\
    (\wedge\ \widebar{\tau_i' \rightarrow \tau_i''}) \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma
    \models 
    (\lambda\ \widebar{m_i \Rightarrow e_i})^z : \tau
  } 

  \inferrule { 
    \Delta \cdot \Gamma \cdot \tau' \models e : (l : \tau)
    \\
    \text{fresh}\ \alpha
    \\\\
    \Delta \models \tau' \leq (l : \alpha)
    \\
    \alpha \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma \models (e/l)^z : \tau
  } 

  \inferrule { 
    \text{fresh}\ \alpha
    \\
    \Delta \cdot \Gamma \cdot \tau_1 \models e_1 : (\alpha \rightarrow \tau)
    \\
    \Delta \cdot \Gamma \cdot \tau_2 \models e_2 : \alpha
    \\\\
    \text{fresh}\ \alpha'
    \\
    ...
    \Delta\ \cdot \Gamma \cdot \alpha'' \models (e_1\ e_2)^z : \tau
  } 
  \\\\
  \inferrule { 
    \Delta \cdot \Gamma \cdot \tau_1' \models e_1 : \tau_1 
    \\
    \tau_1'[\Delta] = \tau_1''
    \\
    ...
    \\
    \Delta \cdot \Gamma \cdot \tau_2' \models e_2 : \tau_2
    \\
    \tau_2'  \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma\models (\text{let}\ x : \tau_1 = e_1\ \text{in}\ e_2) : \tau_2
  } 

  \inferrule { 
    \Delta \cdot \Gamma \cdot \tau' \models e : \bot \rightarrow \tau 
    \\
    \text{fresh}\ \alpha_1
    \\
    \text{fresh}\ \alpha_2
    \\\\
    \Delta \models \tau' \leq \alpha_1 \rightarrow \alpha_2
    \\
    \alpha_1[\Delta] = \tau_1
    \\
    \alpha_2[\Delta] = \tau_2
    \\\\
    (\text{fixtype}\ \tau_1\ \tau_2) \sqsubseteq (\Gamma\ z)
  } {
    \Delta\ \cdot \Gamma 
    \models \text{fix}\ e : \tau
  } 
