...
as SMT solvers may provide results very fast for certain problems due to its search space pruning based on SAT's conflict driven clause learning (CDCL) and boolean constraint propagation (BCP). 
...
a future research direction. Additionally, our system of type reconstruction offers alternative mechanisms for pruning the search  
space, which may compensate for lack of SAT.
\newline
...
by pruning the search space, just as CDCL and BCP combine to prune the search space in SAT. 
\newline
