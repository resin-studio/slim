...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \tau \in \text{abstract}(E)
  } 

  \inferrule { 
    T \cap \left< \cdot \vdash e \right> \not\subseteq \emptyset 
  } {
    e \in \text{concretize}(T)
  } 
  ...
  \inferrule { 
    ...
    (\left< \cdot \vdash e \right> \subseteq \text{abstract}(\left< e \right>))
    \equiv
    (\left< e \right> \subseteq \text{concretize}(\left< \cdot \vdash e \right>))
  } 
\end{mathpar}
