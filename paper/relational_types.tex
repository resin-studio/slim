...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \text{fresh}\ \alpha'
    \\
    \Delta \models \tau_1 \leq \tau_2 \rightarrow \alpha'
    \\
    \text{fresh}\ \alpha''
    \\
  ...
  \inferrule { 
    ...
    \\\\
    \left< \Delta, (\Gamma, x = \forall \widebar{\alpha} . \tau_1'), \tau_2' \right>  
  ...
  \inferrule { 
    \left< \Delta, \Gamma, \tau' \right> 
    \in \llbracket e : \bot \rightarrow \tau \rrbracket\sharp
    \\
    \text{fresh}\ \alpha_1
    \\
    \text{fresh}\ \alpha_2
    ...
    \left< \Delta, \Gamma, (\text{fixtype}\ \tau_1\ \tau_2) \right>
