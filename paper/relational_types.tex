...
% additional observations 
  % result: type inference without constraints 
    ...
    % novel solution: 
      % two independent sufficient reasons we don't need constraints:
        % we eagerly unify, and just propagate resulting type environment
        % the subtyping semantics is sufficiently expressive to record constraints 
