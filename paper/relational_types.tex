...
% an initial condition is akin to a weakest precondition of the implication type of fix
% a safety condition is akin to a strongest postcondition of the implication type of fix

% an interpolant of a fix's implication is akin to a nu-type 
% a subtype of the strongest postcondition and supertype of the weakest precondition 
