...
\begin{mathpar}
  ...
  \inferrule {
    ...
    (\omega\ \widebar{l_i = v_i})/l_j \leadsto v_j
  } 
...
\[
  \begin{array}{l @{} l}
    ...
    \text{unify}\ v\ p
    \\
    \text{unify}\ (\omega\ \widebar{l = v})\ (\omega\ \widebar{l = p}) 
    &{} =
...
\begin{mathpar}
  \inferrule { 
    ...
    \left<\left<\rho_\kappa, x_\kappa, e_\kappa\right> :: \kappa, \rho, () \right> 
    \leadsto 
    \left<\kappa, (\rho_\kappa,x_\kappa \mapsto \left<\rho,()\right>), e_\kappa \right>
  } 
...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \Gamma \vdash \omega\ (\widebar{l_i = t_i})
