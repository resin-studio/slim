...
% main results 
  % result: synthesis from context (without annotations) 
  ...
  % result: inference of expressive types
  ...
  % result: safe but lenient type inference without prescription
  ...
  % result: instantiation of polymorphic arguments to narrow search
  ...
  % result: type inference without constraints 
