...
\begin{definition}[Typed state abstraction]
\begin{flalign*}
  &\boxed{\left< \kappa, \rho, e \right> \rightleftharpoons \left< \Xi, \Gamma, \tau \right>}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
    \kappa \rightleftharpoons \Xi
    \\
    \rho \rightleftharpoons \Gamma
  } {
    \left< \kappa, \rho, () \right> 
    \rightleftharpoons 
    \left< \Xi, \Gamma, \text{unit} \right>
  } 
...
\begin{definition}[Typed state transition]
\begin{flalign*}
  &\boxed{\left< \Xi, \Gamma, e, \tau \right> \leadsto \left<  \Xi, \Gamma, e, \tau \right>}&
\end{flalign*}
\begin{mathpar}
  \inferrule { 
  } {
    \left< \Xi, \Gamma, e, \tau \right> 
    \leadsto 
    \left<  \Xi, \Gamma, e, \tau \right>
  } 
\end{mathpar}
...
% motivation of abstract interpretation
  ...
  % analysis techniques
    % compositional (structural termination) (directed dependence) 
      % type system
    %flow (monotonic termination) (mutual dependence) (approximate function application) 
      % constraint-based 
