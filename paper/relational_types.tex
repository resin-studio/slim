    ...
    \begin{array}{l @{} l}
      ...
      \begin{cases}
        ...
        \begin{array}[t]{@{} l}
          \{\Delta_1;\Delta_2\ |
          \\ 
          \ \ \ \ \Delta_1 \in \text{unify } \iota\ \Delta \vdash \tau_2 \leq \text{extractprem } \alpha\ \tau_1
          \\
          \ \ \ \ \Delta_2 \in \text{unify } \iota\ \Delta;\Delta_1 \vdash \tau_3 \leq \text{extractconc } \alpha\ \tau_1
          \\
          \}
        \end{array}
        &\text{otherwise }
