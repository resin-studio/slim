...
% there are two distinct purposes of quantification over types
  % 1. polymorphic - ignoring a sub part of a type (typically 2nd order) 
  % 2. constrained - defining a type based on constraints (typically 1st order)
% there are two distinct forms of composition checks 
  % 1. instantiation a quantified type
  % 2. refinement of quantified type 
