...
\begin{mathpar}
  \inferrule {
    ...
    (\Delta, \alpha \mapsto \text{narrow}\ \alpha\ \tau) 
    \in \llbracket \alpha \leq \tau \rrbracket^\sharp
  }

  \inferrule {
    (\Delta\ \alpha) = \tau'
    \\
    (\Delta;\Delta') \in \llbracket \tau' \leq \tau \rrbracket^\sharp
  } {
    (\Delta;\Delta') \in \llbracket \alpha \leq \tau \rrbracket^\sharp
  }

  \inferrule {
    (\Delta\ \alpha) = \tau'
    \\
    \llbracket \tau' \leq \tau \rrbracket^\sharp \subseteq \emptyset
  } {
    (\Delta, \alpha \mapsto \text{narrow}\ \tau' \tau) 
    \in \llbracket \alpha \leq \tau \rrbracket^\sharp
  }
  \\\\
  \inferrule {
    ...
    (\Delta, \alpha \mapsto \text{widen}\ \tau\ \alpha) 
    \in \llbracket \tau \leq \alpha \rrbracket^\sharp
  }
  ...
  \inferrule {
    ...
    (\Delta;\Delta') \in \llbracket \tau \leq \alpha \rrbracket^\sharp
  }
  ...
  \inferrule {
    ...
    (\Delta, \alpha \mapsto \text{widen}\ \tau\ \tau') 
    \in \llbracket \tau \leq \alpha \rrbracket^\sharp
  }
