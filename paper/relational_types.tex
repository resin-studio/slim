...
% comparison to model checking
  ...
  % union/intersection adjustment is a compositional version of 
    % abstract interpretation's (widening,expansion)/(narrowing,contraction)
...
% comparison of transition systems vs compositional systems 
  % transitions with widening/narrowing correspond to compositional type adjustment
    % demonstrate that a compositional technique is as expressive as a small-step semantics.
    % without the overhead of small-step semantics. 
