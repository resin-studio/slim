...
\begin{mathpar}
  ...
  \inferrule { 
    ...
    \longrightarrow
    (\Delta;\Delta' \claim \tau_3 \subtypes \tau_4)
  } { 
    \Delta \claim \left<\exists \widebar{\alpha_i}\ .\ \tau_3\ |\ \tau_1 \subtypes \tau_2\right>
    \subtypes \tau_4
  }
  ...
  \inferrule { 
    (\text{freevars}\ \Delta) \cap \widebar{\alpha_i} \subseteq \emptyset 
    \\\\
    \Delta;\Delta' \claim \tau_1
    \subtypes \tau_4
    \\
    \Delta;\Delta' \claim \tau_2
    \subtypes \tau_3
  } { 
    \Delta \claim \tau_1
    \subtypes \left<\exists \widebar{\alpha_i}\ .\ \tau_4\ |\ \tau_2 \subtypes \tau_3\right>
  }
  ...
  \inferrule { 
    ...
    \\\\
    \bigwedge\nolimits_{\Delta'}
    (\Delta;\Delta' \claim \tau_2 \subtypes \tau_3)
    \longrightarrow
    (\Delta;\Delta' \claim \tau_1 \subtypes \tau_4)
  } { 
    \Delta \claim \tau_1
    \subtypes \left<\forall \widebar{\alpha_i}\ .\ \tau_4\ |\ \tau_2 \subtypes \tau_3\right>
  }

  \inferrule { 
    (\text{freevars}\ \Delta) \cap \widebar{\alpha_i} \subseteq \emptyset 
    \\\\
    \Delta;\Delta' \claim \tau_3
    \subtypes \tau_4
    \\
    \Delta;\Delta' \claim \tau_1
    \subtypes \tau_2
  } { 
    \Delta \claim \left<\forall \widebar{\alpha_i}\ .\ \tau_3\ |\ \tau_1 \subtypes \tau_2\right>
    \subtypes \tau_4
  }
  \\
  \inferrule { 
    \Delta \claim \tau_1[\alpha_1\mapsto\mu\alpha_2.\tau_2]
    \subtypes \tau_2[\alpha_2\mapsto\mu\alpha_2.\tau_2]
  } { 
    \Delta \claim \mu \alpha_1 . \tau_1
    \subtypes \mu \alpha_2 . \tau_2
  }

  \inferrule {
  } {
    \Delta \claim \tau[\alpha\mapsto\mu \alpha . \tau]
  ...
  \inferrule {
    ...
    \subtypes \tau[\alpha\mapsto\mu \alpha . \tau]
  }

  \inferrule { 
    \Delta \claim \tau_1[\alpha_1\mapsto\nu\alpha_1.\tau_1] 
    \subtypes \tau_2[\alpha_2\mapsto\nu\alpha_1.\tau_1]
  } {
    \Delta \claim \nu \alpha_1 . \tau_1 
    \subtypes \nu \alpha_2 . \tau_2
  }
