...
\begin{array}[t]{@{} l}
    ...
    \I\I solution \leftarrow [(\Delta, \top)]
    \\
    \I\I \text{for } (\widebar{\code{path $m_i$ => $e_i$}}) \leftarrow (\widebar{\code{path $m$ => $e$}}) 
    \\
    ...
    \I\I\I\I \text{for } (\Delta, \tau) \leftarrow solution 
    \\
    \I\I\I\I\I \text{for } (\Delta, \tau_{mi}) \leftarrow (\text{infer } \Delta\ \Gamma\ m_i) 
    \\
    \I\I\I\I\I\I \text{for } (\Delta, \tau_{ei}) \leftarrow (\text{infer } \Delta\ \Gamma\ e_i) 
    \\
    \I\I\I\I\I\I\I [(\Delta, \code{($\tau_{mi}$->$\tau_{ei}$) \& $\tau$})])
    \\
    \I\I solution
    %
\end{array}
