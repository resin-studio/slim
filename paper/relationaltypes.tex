...
\begin{flalign*}
  &\boxed{\F{infer}\ \Delta\ \Gamma e\ \tau = \widebar{(\Delta, \tau)}}&
\end{flalign*}
...
\begin{array}[t]{@{} l}
    ...
    \\
    % \I\I \widebar{x_t} \leftarrow \F{allvars}
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\F{unify}\ \Delta\ \tau_{l}\ \tau_{r} = \widebar{\Delta}}&
\end{flalign*}
\[
\begin{array}[t]{@{} l}
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\F{unifyContd}\ \Delta\ \tau_{l}\ \tau_{r} = \widebar{\Delta}}&
\end{flalign*}
\[
\begin{array}[t]{@{} l}
    ...
    \\
    \I\I\I\I \tau_{body} \leftarrow (\text{sub } \Delta\ \tau_{body}) 
    \\
    \I\I\I\I (\text{unify } (\Delta;\code{$\alpha$<:$\tau_{arg}$})\ \tau_{body}\ \tau_{res})
    \\
    \I\I \B{else } []
    ...
    \\
    \I\I\I \tau_{body} \leftarrow (\text{sub } \Delta\ \tau_{body}) 
    \\
    \I\I\I (\text{unify } \Delta\ \tau_{body}\ \tau_{res})
