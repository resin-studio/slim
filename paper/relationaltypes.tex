...
type variables in the inferred argument type while maintaining
...
\begin{array}[t]{@{} l}
    ...
    \\
    \I\I\I\I \tau_{\Delta} \leftarrow \F{pack}(\Omega_{stale}, \Delta, \tau_a)
    \\
    \I\I\I\I \alpha \leftarrow \F{freshTV}()
    \\
    \I\I\I\I \F{infer}(\Omega, \Delta, (\Gamma;\code{$x$:[$\alpha$<:$\tau_{\Delta}$]$\alpha$}), e_b)
    \\
    \I\I \B{else } \emptyset 
