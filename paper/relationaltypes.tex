...
\begin{flalign*}
  &\boxed{\text{infer}\ \Delta\ \Gamma e\ \tau = \widebar{(\Delta, \tau)}}&
\end{flalign*}
...
\begin{array}[t]{@{} l}
    ...
    \I\I\I solution \leftarrow (
    \\
    \I\I\I\I \text{for } \Delta_c \leftarrow \widebar{\Delta_c} 
    \\
    \I\I\I\I\I \widebar{\Delta} \leftarrow (\text{unify}\ \Delta_c\ \tau\ \tau_r)
    \\
    \I\I\I\I\I \text{if } (\text{empty } \Delta) \text{ then } 
