...
\begin{array}[t]{@{} l}
    ...
    \B{ else } 
    \\
    \I \F{unifyDecomp}(\Omega, \Delta, \tau_{l}, \tau_{r})
\end{array}
\]
...
\begin{array}[t]{@{} l}
    ...
    \I \C{final}
    \\
    \I \B{case } \tau_l, \tau_r : \F{unifyFinal}(\Omega, \Delta, \tau_l, \tau_r)
\end{array}
\]
...
\begin{figure*}[h]
\begin{flalign*}
  &\boxed{\F{unifyFinal}(\Omega, \Delta, \tau_{l}, \tau_{r}) = C}&
\end{flalign*}
\[
\begin{array}[t]{@{} l}
    \F{unifyFinal}(\Omega, \Delta, \tau_{l}, \tau_{r}) \triangleq 
    \\
    \I \B{match}\ \tau_{l}, \tau_{r} 
...
\caption{Subtype unification final}
\end{figure*}
