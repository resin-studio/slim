...
%     \\\\
%     \{reduce}\ ;\ \{.l\ \tau_1\ |\ (.l\ t_1, \tau_1) \in fields \} = \tau'
%     \\\\
...
\subsection{Subtyping semantics}
...
\begin{figure*}[h]
  \[
    \begin{array}{l @{} l}
      ...
      \begin{array}[t]{@{} l}
        \{\Omega.\diamondsuit\ |
        \ \Omega \in \text{unify } \iota\ \Delta \vdash \diamondsuit \leq \tau
        \}
      \end{array}
      \\
      ...
      \begin{cases}  
        \{\Omega.\tau_1\ |
        \ \Omega \in \text{unify } \iota\ \Delta \vdash \tau_1 \leq \tau
        \}
      ...
      \begin{array}[t]{@{} l}
        ...
        \\
        \{\Omega_1;;\Omega_2\ .\ l \# \tau_1 \ |
        \\
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash l \# \alpha \leq \tau
        \\
        \ \ \ \ (\Omega_2.\tau_1) \in \text{infer } \iota\ \Delta;;\Omega_1\ \Gamma \vdash t : \alpha
        \\
        \}
      \end{array}
      \\
      ...
      \begin{array}[t]{@{} l}
        ...
        \text{reduce} * \{
        \text{infer } \iota\ \Delta;;\Omega\ \Gamma \vdash t : \alpha\ |\ 
        \\
        \ \ \ \ \Omega \in \text{unify } \iota\ \Delta\ \vdash \tau_1 \leq \tau
        \\
        \ \ \ \ (l := t, \alpha) \in fields
...
\begin{figure*}[h]
  \[
    ...
    \end{array}
  \]
  \caption{Subtyping unification: part 1}
\end{figure*}
  ...
  \[
    \begin{array}{l @{} l}
      ...
      \begin{array}[t]{@{} l}
        ...
        \\ 
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_1 \leq \tau_2
        \\ 
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_3 \leq \tau_6
        \\
        \ \ \ \ \Omega_3 \in \text{unify } \iota\ \Delta;;\Omega_1;;\Omega_2 \vdash \tau_4 \leq \tau_5
        \\
        \}
      \end{array}
      \\
      ...
      \begin{array}[t]{@{} l}
        ...
        \{\Omega_1;;\Omega_2\ |
        \\ 
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_1 \leq \tau_4
        \\
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_2 \leq \tau_3
        \\
        \}
      \end{array}
      \\
      ...
      \begin{array}[t]{@{} l}
        ...
        \{\Omega_1;;\Omega_2;;\Omega_3\ |
        \\ 
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_4 \leq \tau_5
        \\ 
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_3 \leq \tau_6
        \\
        \ \ \ \ \Omega_3 \in \text{unify } \iota\ \Delta;;\Omega_1;;\Omega_2 \vdash \tau_1 \leq \tau_2
        \\
        \}
      \end{array}
      \\
      ...
      \begin{array}[t]{@{} l}
        ...
        \{\Omega_1;;\Omega_2\ |
        \\ 
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_3 \leq \tau_4
        \\
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_1 \leq \tau_2
        \\
        \}
      \end{array}
      \\
      ...
      \begin{array}[t]{@{} l}
        \{\Omega_1;;\Omega_2\ |
        \\ 
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_1 \leq \tau_3
        \\
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_2 \leq \tau_3
        \\
        \}
      ...
      \begin{array}[t]{@{} l}
        ...
        \ \ \ \ \Omega_1 \in \text{unify } \iota\ \Delta \vdash \tau_1 \leq \tau_2
        \\
        \ \ \ \ \Omega_2 \in \text{unify } \iota\ \Delta;;\Omega_1 \vdash \tau_1 \leq \tau_3
        \\
        \}
      \end{array}
