...
\begin{figure*}[h]
  \[
    \begin{array}{l @{} l}
      ...
      \text{infer } \iota\ \Delta\ \Gamma \vdash 
      (\text{let}\ x : (\forall \widebar{\alpha} :: \tau_1 \leq \tau_2 \ .\ \tau_3) := t_1 \text{in } t_2) : \tau_2
      &{} =
      \begin{array}[t]{@{} l}
        \{ \Delta_2\ .\ \tau_2' \ |\ 
        \\
        \ \ \ \ \Delta_1.\tau_1' \in \text{infer } \iota\ \Delta\ \Gamma \vdash t_1 : (\exists \widebar{\alpha} :: \tau_1 \leq \tau_2 \ .\ \tau_3)
        \\ 
