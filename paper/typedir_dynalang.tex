...
\begin{figure*}[h]
  \[
    \begin{array}{l @{} l @{} l @{} l }
      ...
      \end{cases}
      \\
      \text{unify } \ \iota\hfill \Delta &{} \vdash \bot \leq \_	
      &{}=\ &{} 
      \begin{array}[t]{l}
        \{\cdot\}
      \end{array}
      \\
      \text{unify } \ \iota\hfill \Delta &{} \vdash \_ \leq \top	
      &{}=\ &{} 
      \begin{array}[t]{l}
        \{\cdot\}
      \end{array}
      \\
      \text{unify } \ \iota\hfill \Delta &{} \vdash \diamondsuit \leq \diamondsuit	
      &{}=\ &{} 
      \begin{array}[t]{l}
        \{\cdot\}
      \end{array}
      \\
      \text{unify } \ \iota\hfill \Delta &{} \vdash l \# \tau_1 \leq l \# \tau_2	
      &{}=\ &{} 
      \begin{array}[t]{l}
        \text{let } x = \text{foo}() \Rightarrow
        \\
        \text{let } x = \text{foo}() \Rightarrow 
        \\
        \lambda [\text{for } x \Rightarrow \text{foo}(x)]
      \end{array}
    \end{array}
  \]
