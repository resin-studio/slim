...
including ACL2, Twelf, Coq, Lean, Liquid Haskell, HOL, and Isabelle.  
...
Tor the typical Python or JavaScript programmer, 
the cost of their extreme expressivity would likely be too burdensome.
