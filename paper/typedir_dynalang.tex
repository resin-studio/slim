...
\begin{figure*}[h]
  \begin{mathpar}
    ...
    \inferrule[Record] { 
      ...
      \Gamma \vdash \omega[fields] : (\text{reduce}\ ;\ types)  
    } 
    ...
    \inferrule[Function] {
      ...
      \Gamma \vdash \lambda[cases] : (\text{reduce}\ ;\ types)  
    } 
    ...
    \inferrule[Let] { 
      \Gamma \vdash t_1 : \exists \widebar{\alpha} :: \tau_3 \leq \tau_4\ .\ \tau_1
      \dashv
      C
      \\\\
      \Gamma,x \mapsto \forall \widebar{\alpha} :: \tau_3 \leq \tau_4\ .\ \tau_1
        \vdash t_2 : \tau 
      \dashv
      C
      \\
      \widebar{\alpha} = \text{freevars}\ \tau_1
    } {
      \Gamma \vdash (\text{let}\ x : \tau_1 = t_1 \text{ in } t_2) : \tau 
      \dashv
      C;;(\exists \widebar{\alpha} :: \tau_3 \leq \tau_4)\ 
    } 
    ...
    \inferrule[Subsump] { 
      \Gamma \vdash t : \tau'[] \dashv C
      \\
      \Delta\ \vdash \tau' \leq \tau \dashv C
    } {
      \Gamma \vdash t : \tau \dashv C
    } 
...
\mprset{flushleft}
  ...
  \inferrule[bottom] {
    ...
    \Delta \vdash \bot \leq \tau \dashv C
  }

  \inferrule[top] {
  } {
    \Delta \vdash \tau \leq \top \dashv C
  } 
