...
\begin{figure*}[h]
  \begin{mathpar}
    ...
    \inferrule[Let] { 
      \Gamma \vdash t_1 : \exists \widebar{\alpha} :: \tau_1 \leq \tau_2\ .\ \tau_3
      \\\\
      \Gamma,x \mapsto \forall \widebar{\alpha} :: \tau_1 \leq \tau_2\ .\ \tau_3
        \vdash t_2 : \tau_4 
    } {
      \Gamma \vdash 
        (\text{let}\ x : (\forall \widebar{\alpha} :: \tau_1 \leq \tau_2\ .\ \tau_3) 
        = t_1 \text{ in } t_2) : \tau_4
    } 
...
\begin{figure*}[h]
  \begin{mathpar}
    ...
    \inferrule[exis-symm] { 
      ...
      \Delta \vdash 
        (\exists \widebar{\alpha} :: \tau_1 \leq \tau_2\ .\ \tau_3)
        \leq 
        (\exists \widebar{\alpha} :: \tau_4 \leq \tau_5\ .\ \tau_6)
    }
    ...
    \inferrule[univ-symm] { 
      ...
      \Delta \vdash 
        ...
        \leq 
        (\forall \widebar{\alpha} :: \tau_4 \leq \tau_5\ .\ \tau_6)
    }
