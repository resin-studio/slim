...
\inferrule[App]
  { 
    \text{fresh}\ \alpha\ \beta\ \gamma_1\ \gamma_2
    \\
    ...
    \Omega_1.\tau_1' \in N_1
    \\\\
    \Delta;\Omega_1\ \Gamma \vdash t_2 : (\alpha\ \&\ \gamma_1)
      \rightsquigarrow N_2
    \ \wedge\ 
    \Omega_2.\tau_2' \in N_2
    \\\\
    \Delta;\Omega_1;\Omega_2 \vdash \tau_1' \leq (\tau_2'\ |\ \gamma_2 \rightarrow \beta)
      \rightsquigarrow M_3
    \ \wedge\ 
    \Omega_3 \in M_3
    \\\\
...
% widening in type inference: union to arg type of application (τ | ?)
% narrowing in type inference: intersection to param type of application (τ & ?)
