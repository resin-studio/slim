...
\inferrule[Record]
  { 
    ...
    \\\\
    \text{reduce}\ ;\ \{.l\ \tau_1\ |\ (.l\ t_1, \tau_1) \in fields \} = \tau'
    \\\\
    \Delta\ \vdash \tau' \leq \tau \rightsquigarrow M
    \\\\
    \text{reduce} * \{N_1\ |\ 
    \\\\
    \ \ \ \ (.l\ t_1, \tau_1) \in fields \\ \Delta_1 \in M
    \\\\
    \ \ \ \ \Delta;;\Delta_1\ \Gamma \vdash t_1 : \tau_1 \rightsquigarrow N_1
    \\\\
    \} = N
  }
...
\inferrule[Function]
  {
    ...
    \\\\
    \text{reduce}\ ;\ \{\tau_1 \rightarrow \tau_2\ |\ 
    ...
    \ \ \ \ (\lambda\ t_1 : \tau_1 \Rightarrow t_2, \tau_2) \in cases 
    \\\\
    \ \ \ \ \text{pat\_wf}\ t_1 \\ \text{fresh\_env}\ t_1 = \Gamma_x \\ \Delta_1 \in M
    \\\\
    \ \ \ \ \Delta;;\Delta_1\ \Gamma;;\Gamma_x \vdash t_1 : \tau_1 \rightsquigarrow N_1
    \\
    \Delta_2\ .\ \tau_1' \in N_1
    \\\\
    \ \ \ \ \Delta;;\Delta_1;;\Delta_2\ \Gamma;;\Gamma_x \vdash t_2 : \tau_2 \rightsquigarrow N_2
    \\\\
    \} = N
  }
  {\Delta\ \Gamma \vdash t : \tau  
...
\inferrule[Proj]
  {
    ...
    \\ \Delta_1.\tau_1 \in N_1
    \\\\
    \\ \Delta;;\Delta_1 \vdash \tau_1 \leq .l\ \alpha \rightsquigarrow M_2
    \\ \Delta_2 \in M_2
    \\\\
    \} = N
  }
...
\inferrule[App]
  { 
    ...
    \\ \Delta_1.\tau_1' \in N_1
    \\\\
    \\\Delta;;\Delta_1\ \Gamma \vdash t_2 : \alpha
      \rightsquigarrow N_2
    \\ \Delta_2.\tau_2' \in N_2
    \\\\
    \} = N
...
\inferrule[Fix]
  { 
    ...
    \\ \Delta_1.\tau_1' \in N_1
    \\\\
    \\ \Delta;;\Delta_1 \vdash \tau_1' \leq \alpha \rightarrow \beta 
    \rightsquigarrow M_2
    \\ \Delta_2 \in M_2
    \\\\
    \\ \alpha[\Delta;;\Delta_1;;\Delta_2] = \tau_\alpha
    \\ \beta[\Delta;;\Delta_1;;\Delta_2] = \tau_\beta
    \\\\
...
%     \Delta_1 \in M_1
%     \\\\
%     \ \ \ \ \Delta;;\Delta_1 \vdash \tau_2 \leq \tau \rightsquigarrow M_2  
%     \\
%     \Delta_2 \in M_2
%     \\\\
%     \} = M
...
%     \Delta_1 \in M_1
%     \\\\
%     \ \ \ \ \Delta;;\Delta_1 \vdash \tau \leq \tau_2 \rightsquigarrow M_2  
%     \\
%     \Delta_2 \in M_2
%     \\\\
%     \} = M
  ...
  \[
    \begin{array}{l @{} l}
      ...
      \begin{array}[t]{@{} l}
        ...
        \\
        \ \ \ \ \Delta_2.\tau_1' \in \text{infer } \iota\ \Delta;;\Delta_1\ \Gamma;;\Gamma_1\ \vdash t_1 : \tau_1
        \\
        \}
        \\
      \end{array}
      ...
      \begin{array}[t]{@{} l}
        ...
        \\
        \ \ \ \ \Delta_1.\tau_1 \in
        \text{infer } \iota\ \Delta\ \Gamma \vdash t : \tau \rightarrow \tau
        \\
        \ \ \ \ \Delta_2 \in \text{unify } \iota\ \Delta;;\Delta_1 \vdash 
