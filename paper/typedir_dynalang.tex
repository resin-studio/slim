...
% correspondence to dependent types
  ...
  % relational types
    ...
    %
    % P ≡ ∃ N L :: F ≤ L -> N => (N × L) 
  % in DT, sigma ads the necessary term to satisfy constraints 
  % since a term may be a dependency for a type without actually being in that type.
  % in RT, a term can only be a dependency of a type if it is in that type 
