...
\begin{figure*}[h]
  \begin{mathpar}
    ...
    \inferrule[Record] { 
      \bigwedge_{l \approx v} 
      \bigwedge_{l \approx t} 
      t \Downarrow v 
    } {
      \omega\ (\widebar{l \approx t}) : \omega\ (\widebar{l \approx v})  
    } 
    ...
    \inferrule[Proj] {
      t \Downarrow \omega [\hdots, l \approx v, \hdots] 
    } {
      t/l \Downarrow v
    } 

    \inferrule[App] { 
      t_1 \Downarrow \lambda\ \widebar{p : \tau \Rightarrow t_3}
      \\
      t_2 \Downarrow v_1 
      \\\\
      (\text{match } v_1\ \widebar{p : \tau \Rightarrow t_3}) \Downarrow v
    } {
      t_1\ t_2 \Downarrow v 
    } 
...
\begin{figure*}[h]
  \[
    \begin{array}{l @{} l}
      ...
      &{} =
      \begin{array}[t]{@{} l}
        \text{let } fields' = \{(l \approx t, \text{typevar}())\ |\ (l \approx t) \in fields \}
        \\
        \text{let } \tau_1 = \text{reduce} \wedge \{l \sim \alpha\ |\ (l \approx t, \alpha) \in fields' \}
        \\
