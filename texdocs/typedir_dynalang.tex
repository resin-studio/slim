...
\inferrule[corec-case]
  { 
    \Delta \vdash
    \forall \beta :: \tau[\alpha/\nu\alpha.\tau]\leq (\beta \rightarrow \tau_2)\ .\ \beta \leq \tau_1
    \rightsquigarrow \Delta_1
    \\\\
    \Delta \vdash
    \forall \beta :: \tau[\alpha/\nu\alpha.\tau]\leq (\tau_1 \rightarrow \beta)\ .\ \beta \leq \tau_2
...
\inferrule[record-step]
  {  
    \Delta\ \tau_0 \vdash \tau_1 \leq \exists \beta ::
...
\inferrule[exis-free]
  { 
    \Delta \vdash \tau_1 \leq \tau_2 \rightsquigarrow \Delta_1
    \\
    \Delta;\Delta_1 \vdash \tau' \leq \tau \rightsquigarrow \Delta_2
    \\
    \text{fresh}\ \alpha_i
  }
  { 
...
\inferrule[Var]
  ...
  {\Delta\ \Gamma \vdash x : \tau  \rightsquigarrow \Delta_1 . \tau' } 
...
\inferrule[Tag]
  { 
    ...
    \\\\
    \Delta;\Delta_1\ \Gamma \vdash t : \alpha \rightsquigarrow \Delta_2 . \tau'
  }
  {\Delta\ \Gamma \vdash \#l\ t : \tau  \rightsquigarrow \Delta_1;\Delta_2 . \tau' } 

\inferrule[RecordBase]
  { 
    \text{fresh}\ \alpha
    \\
    \Delta \vdash .l\ \alpha \leq \tau \rightsquigarrow \Delta_1
...
\inferrule[RecordStep]
  {
    ...
    \\
    \Delta \vdash .l\ \alpha\ \&\ \beta \leq \tau  \rightsquigarrow \Delta_{\alpha\beta}
    \\
    \Delta;\Delta_{\alpha\beta}\ \Gamma \vdash .l\ t_1 : .l\ \alpha  \rightsquigarrow \Delta_1 . \tau_1'
    \\
    \Delta;\Delta_{\alpha\beta}\ \Gamma \vdash t_2 : \beta  \rightsquigarrow \Delta_1 . \tau_2'
  }
  {\Delta\ \Gamma \vdash (.l\ t_1;\ t_2) : \tau  \rightsquigarrow \Delta_{\alpha\beta};\Delta_1;\Delta_2 . \tau_1'\ \&\ \tau_2' } 

\inferrule[FunctionBase]
  { 
    \text{fresh}\ \alpha_i \\ \text{fresh}\ \beta
    \\
    \Delta\ \Gamma \vdash
    \tau_1[?/\alpha_i] \rightarrow \beta \leq \tau
    \rightsquigarrow \Delta_1
    \\\\
    \text{patvars}\ t_1 = x_i \\ \text{fresh}\ x_i
    \\
    \Delta;\Delta_1\ \Gamma \vdash 
      t_2 : \beta  
      \rightsquigarrow \Delta_2.\tau_2'
  }
  {\Delta\ \Gamma \vdash 
    (\lambda\ t_1 : \tau_1 \Rightarrow t_2) : \tau  
    \rightsquigarrow \Delta_1;\Delta_2\ .\ \tau_1[?/\alpha_i] \rightarrow \tau_2'
  } 

\inferrule[FunctionStep]
  {
    \text{fresh}\ \alpha \\ \text{fresh}\ \beta
    \\
    \Delta \vdash (\tau_p \rightarrow \alpha)\ \&\ \beta \leq \tau  \rightsquigarrow \Delta_{\alpha\beta}
    \\
    \Delta;\Delta_{\alpha\beta}\ \Gamma \vdash \lambda\ t_p : \tau_p \Rightarrow t_1 : (\tau_p \rightarrow \alpha)  \rightsquigarrow \Delta_1 . \tau_1'
    \\
    \Delta;\Delta_{\alpha\beta}\ \Gamma \vdash t_2 : \beta  \rightsquigarrow \Delta_1 . \tau_2'
  }
  {\Delta\ \Gamma \vdash (\lambda\ t_p : \tau_p \Rightarrow t_1;\ t_2) : \tau  \rightsquigarrow \Delta_{\alpha\beta};\Delta_1;\Delta_2 . \tau_1'\ \&\ \tau_2' } 

\inferrule[Proj]
  {
    \Delta\ \Gamma \vdash t_1 : .l\ \tau \rightsquigarrow \Delta_1.\tau_1
    \\
    \text{project}\ \tau_1\ l = \tau'
  }
  {\Delta\ \Gamma \vdash t_1.l : \tau \rightsquigarrow \Delta_1.\tau'} 

\inferrule[App]
  { 
    \text{fresh}\ \alpha \\ \text{fresh}\ \beta
    \\\\
    \Delta\ \Gamma \vdash t_2 : (? \rightarrow \tau) \rightsquigarrow \Delta_1.\tau_2 
    \\\\
    \Delta;\Delta_1 \vdash \tau_2 \leq \alpha \rightarrow \beta \rightsquigarrow \Delta_2
    \\\\
    \Delta;\Delta_1;\Delta_2\ \Gamma \vdash t_1 : \alpha \rightsquigarrow \Delta_3.\tau_1' 
    \\\\
    \Delta;\Delta_1;\Delta_2;\Delta_3 \vdash \tau_2 \leq \tau_1' \rightarrow \tau  \rightsquigarrow \Delta_4 
  }
  {\Delta\ \Gamma \vdash t_2\ t_1 : \tau \rightsquigarrow \Delta_1;\Delta_2;\Delta_3;\Delta_4 . \beta} 
