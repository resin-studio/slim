...
\inferrule[var-rght]
  ...
  {\Delta \vdash \tau \leq \alpha \rightsquigarrow  \{\alpha \mapsto \tau_1 \ |\ \beta \} } 
% \inferrule[var-rght]
%   {  
%     \Delta (\alpha) =\ ? \\ \text{fresh}\ \beta  
%   }
...
\inferrule[recur-base]
  { 
     \Delta \vdash \tau' \equiv \tau\ \wedge \{\} = \Delta_1\ \vee\ 
     \Delta \vdash \tau'[\alpha/\mu \alpha . \tau] \leq \tau[\alpha/\mu \alpha . \tau] \rightsquigarrow \Delta_1
  }
...
\inferrule[record-step]
  {  
    \Delta \vdash \tau_1 \leq \exists \beta ::
