...
\begin{enumerate}
  ...
  \item type inference without principal type schemes: 
    \begin{enumerate}
      \item lenient (but unsound) static type inference
      \item expanding type info with union and intersection and dynamic type
    \end{enumerate}
  \item interleaving constraint generation and solving with dynamic type 
\end{enumerate}
...
To the best of my knowledge, they are all sounds and complete.
They do not exhibit the notion of intersection and union to keep types open.
...
In contrast, our system will still try 
to find lenient static bounds for parts of types marked "?"
