...
\inferrule[recur-tag]
  {\Delta \vdash  \#l\ \tau' \leq \tau[\alpha/\mu \alpha . \tau] \rightsquigarrow \Delta_1}
  {\Delta \vdash \#l\ \tau' \leq \mu \alpha . \tau	\rightsquigarrow  \Delta_1 }

\inferrule[recur-record-left]
  {  
    \Delta \vdash \tau_1 \leq (\exists \beta ::
    .l_i\ \beta\ \&\ \tau_2 \leq \tau[\alpha/\mu\alpha.\tau]\ .\ \beta)
