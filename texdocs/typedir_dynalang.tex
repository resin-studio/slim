...
\inferrule[Tag]
  { 
    \text{fresh}\ \alpha
    \\
    \Delta,\alpha \mapsto\ ? \vdash \#l\ \alpha \leq \tau \rightsquigarrow \Delta_1
    \\\\
...
\inferrule[RecordStep]
  {
    \Delta,\alpha\mapsto\ ?, \beta\mapsto\ ? \vdash .l\ \alpha\ \&\ \beta \leq \tau  \rightsquigarrow \Delta_{\alpha\beta}
    \\
