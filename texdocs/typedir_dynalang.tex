...
$\forall$ $\alpha$ . $\alpha$ $\rightarrow$ $\mu$ nat_to_list .
  #zero $\diamondsuit$ $\rightarrow$ #nil $\diamondsuit$ $\cap$ 
  $\forall$ (nat $\rightarrow$ list) $\subseteq$ nat_to_list .
    #succ nat $\rightarrow$ #cons ($\alpha$ $\times$ list)
\end{lstlisting}
...
$\forall$ $\alpha$ . $\alpha$ $\rightarrow$ $\mu$ nat_to_list .
  #zero $\diamondsuit$ $\rightarrow$ #nil $\diamondsuit$ $\cap$ 
  #succ nat $\rightarrow$ #cons ($\alpha$ $\times$ list)
    $\bigcap$  (nat $\rightarrow$ list) $\subseteq$ nat_to_list
\end{lstlisting}
...
$\forall$ $\alpha$ . $\alpha$ $\rightarrow$ $\mu$ nat_to_list .
  ...
  #succ nat $\rightarrow$ #cons ($\alpha$ $\times$ list)
    $\bigwedge$  (nat $\rightarrow$ list) $\leq$ nat_to_list
\end{lstlisting}
...
\begin{lstlisting}[]
let replicate : ? $\rightarrow$ $\mu$ nat_to_list .
  #zero $\diamondsuit$ $\rightarrow$ #nil $\diamondsuit$ & 
  #succ nat $\rightarrow$ #cons (? $\times$ list)
    && (nat $\rightarrow$ list) $\leq$ nat_to_list
\end{lstlisting}
...
$\exists$ $\alpha$ . $\mu$ nat_and_list .
  #zero $\diamondsuit$ $\times$ #nil $\diamondsuit$ $\cup$ 
  $\exists$ (nat $\times$ list) $\subseteq$ nat_and_list .
    #succ nat $\times$ #cons ($\alpha$ $\times$ list)
\end{lstlisting}
...
$\exists$ $\alpha$ . $\mu$ nat_and_list .
  #zero $\diamondsuit$ $\times$ #nil $\diamondsuit$ $\cup$ 
  #succ nat $\times$ #cons ($\alpha$ $\times$ list)
    $\bigcup$ (nat $\times$ list) $\subseteq$ nat_and_list
\end{lstlisting}
...
$\exists$ $\alpha$ . $\mu$ nat_and_list .
  ...
  #succ nat $\times$ #cons ($\alpha$ $\times$ list)
    $\bigvee$ (nat $\times$ list) $\leq$ nat_and_list
\end{lstlisting}
...
\begin{lstlisting}[]
let measurment : $\mu$ nat_and_list .
  #zero $\diamondsuit$ $\times$ #nil $\diamondsuit$ | 
