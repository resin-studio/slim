...
\inferrule[recur-base]
  { }
  {\Delta \vdash \mu \alpha . \tau \leq \mu \alpha . \tau	\rightsquigarrow  \{ \} }
...
\end{mathpar}
\caption{Unification subtyping: reflexive rules}
\end{figure}
...
\inferrule[union-right]
  {
    ...
    \Delta\Delta_1 \vdash \tau \leq \tau_2 \rightsquigarrow \Delta_2  \wedge 
    \Delta_1\Delta_2 = \Delta_3\vee
    \\
    \Delta \vdash \tau \leq \tau_1 \rightsquigarrow \Delta_1  \wedge
    \Delta_1 = \Delta_3 \vee
    \\
...
\inferrule[inter-left]
  {
    ...
    \Delta\Delta_1 \vdash \tau_2 \leq \tau \rightsquigarrow \Delta_2 \wedge 
    \Delta_1\Delta_2 = \Delta_3 \vee
    \\
    \Delta \vdash \tau_1 \leq \tau \rightsquigarrow \Delta_1 \wedge 
    \Delta_1 = \Delta_3 \vee
