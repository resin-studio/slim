...
\inferrule[recur-tag]
  {\Delta \vdash  \#l\ \tau' \leq \tau[\alpha/\mu \alpha . \tau] \rightsquigarrow \Psi}
  {\Delta \vdash \#l\ \tau' \leq \mu \alpha . \tau	\rightsquigarrow  \Psi }

\inferrule[recur-record]
  { ... }
  {\Delta \vdash .l_i\ \tau' \leq \mu \alpha . \tau	\rightsquigarrow  \Psi }
